...
def setup(dp: Dispatcher):
    ...
    dp.register_message_handler(messages.handle_link, types.ChatType.is_private, RegexFilter)
    ...
    dp.register_inline_handler(inlines.handle_inline_link, RegexFilter)
